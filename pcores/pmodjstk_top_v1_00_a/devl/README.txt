...
Peripheral Summary:
  ...
  XPS project / EDK repository               : /afs/ir.stanford.edu/class/ee109/groups/6/jstk
  logical library name                       : pmodjstk_top_v1_00_a
  top name                                   : pmodjstk_top
  version                                    : 1.00.a
  type                                       : AXI4LITE slave
...
-user needs to add these to repositories path in SDK (Xilinx Tools-->Repositories)
  ...
  data/pmodjstk_top_v2_1_0.mdd

    This is the Microprocessor Driver Definition file.

  data/pmodjstk_top_v2_1_0.tcl
...
axi_lite_ipif_v1_01_a
	/opt/Xilinx/13.4/ISE_DS/EDK/hw/XilinxProcessorIPLib/pcores/axi_lite_ipif_v1_01_a/doc/axi_lite_ipif_ds765.pdf
